...
% Illumination compensation algorithm to deal with different light
% environment
% input - original image of the hand
% output - image of the hand with illumination compensation 
